...
public class Collection {
	...
	public static void main(String[] args) {
		...
		System.out.println("----");
		Iterator<Integer> it = ll.iterator();		// iterator는 컬렉션에 저장되어 있는 요소들을 읽어오는 방법
		
		while (it.hasNext()) {						// 다음 애를 가지고 있는지, 읽어올 요소가 남아있는지 물어보는거임 -> 있으면 true 없으면 false
		...
		for (Integer tmp : al) {					// ArrayList의 값을 하나씩 꺼내서 tmp에 넣어주겠다
			System.out.println(tmp);
		}
		
		System.out.println("--------");
		System.out.println("al2출력");
